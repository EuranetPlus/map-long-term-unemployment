export const config = {
	mapTitle: 'long-term-unemployment-europe', // The title of the map, if more than one word, separate by dash, e.g. "income-europe"
	vercelURL: 'https://map-long-term-unemployment.vercel.app/', // The url provided when deploying the map on Vercel
